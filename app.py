...
from src.ingest import load_uploaded, predict_new_readings
...
with tab2:
    ...
    st.markdown(
        "CSV/XLSX with a `time` column and channel columns. "
        "Accepted names: `solexs_sdd2_counts`, `hel1os_cdte1_5-20keV`, "
